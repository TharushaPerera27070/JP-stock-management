  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm flex flex-col gap-4 relative overflow-hidden group">
        ...
        <div className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm flex flex-col gap-4 relative overflow-hidden group">
          <div className="absolute -right-6 -top-6 w-32 h-32 bg-gray-800/10 rounded-full blur-2xl group-hover:bg-gray-800/20 transition-all duration-500" />
          <div className="flex items-center justify-between relative z-10">
            <span className="text-gray-400 font-medium">Stock Value</span>
            <div className="p-2 rounded-lg bg-gray-800/20 text-gray-300">
        ...
        <div className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm flex flex-col gap-4 relative overflow-hidden group">
          <div className="absolute -right-6 -top-6 w-32 h-32 bg-gray-800/10 rounded-full blur-2xl group-hover:bg-gray-800/20 transition-all duration-500" />
          <div className="flex items-center justify-between relative z-10">
            <span className="text-gray-400 font-medium">Low Stock Alerts</span>
            <div className="p-2 rounded-lg bg-gray-800/20 text-gray-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            {orders.slice(0,3).map(order => (
              <div key={order.id} className="flex items-center justify-between p-4 rounded-xl bg-gray-800 border border-gray-800 hover:bg-gray-800 transition-colors">
                ...
                <div className="text-right">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full mt-1 inline-block ${
                    order.status === 'Delivered' ? 'bg-gray-800/20 text-gray-300' :
                    order.status === 'Processing' ? 'bg-gray-800/20 text-gray-300' :
        ...
        <div className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            {items.filter(i => i.status !== 'In Stock').map(item => (
              <div key={item.id} className="flex items-center justify-between p-4 rounded-xl bg-gray-800/5 border border-gray-700/10 hover:bg-gray-800/10 transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gray-800/20 flex items-center justify-center text-gray-300">
                    <AlertCircle className="w-5 h-5" />
                  </div>
                  <div>
                ...
                <div className="text-right flex flex-col items-end">
                  <div className="font-bold text-gray-300">{item.quantity} Sqft</div>
                  <span className="text-xs text-gray-400 mt-1">{item.status}</span>
                </div>
              </div>
            ))}
          </div>
