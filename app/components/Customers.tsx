  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setActiveTab('add-customer')} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#E8973A] hover:bg-[#d4832b] text-white text-sm font-medium transition-all shadow-lg shadow-[#E8973A]/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {customers.map((customer) => (
          <div key={customer.id} className="p-6 rounded-2xl bg-gray-800 border border-gray-800 backdrop-blur-sm hover:bg-gray-800 transition-colors group">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#E8973A] flex items-center justify-center text-white font-bold text-lg shadow-lg">
