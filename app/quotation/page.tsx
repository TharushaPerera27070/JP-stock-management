...
function QuotationEditor({ propEditId, propIsViewOnly, onBack }: { propEditId?: string; propIsViewOnly?: boolean; onBack?: () => void }) {
  ...
  return (
    <div className="flex min-h-screen flex-col font-sans">
      ...
      {/* Preview Modal */}
      {showPreview && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 md:p-6 z-50 animate-in fade-in duration-250">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex justify-between items-start w-full mb-4">
          ...
          <div className="flex flex-col items-end text-right flex-1">
            ...
            <span className="text-[10px] text-black max-w-[200px] leading-tight mb-1 font-medium">
              {company.address}
            </span>
