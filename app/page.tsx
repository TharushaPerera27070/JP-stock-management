...
export default function InventoryDashboard() {
  ...
  return (
    <div className="flex h-screen w-full bg-gray-50 text-gray-900 font-sans overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 border-r border-gray-200 bg-gray-50 flex flex-col justify-between transform transition-transform duration-300 md:relative md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6">
        ...
        <header className="h-20 border-b border-gray-200 px-4 md:px-8 flex items-center justify-between backdrop-blur-md bg-gray-50/80 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <div className="flex items-center gap-3 pl-3 md:pl-6 border-l border-gray-200">
              <div className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-[#E8973A] flex-shrink-0" />
